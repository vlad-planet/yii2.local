...
<div class="blog-post-form">
    ...
    <?= $form->field($model, 'content')->widget(\common\modules\blog\widgets\Redactor\widgets\Redactor::class, [
    ...
    <?= $form->field($model, 'status')->dropDownList(\common\modules\blog\models\BlogPost::getStatusList()) ?>
